...
export function getApiUrl(): string {
  ...
  const port = import.meta.env.VITE_ARCHIVEMIND_SERVER_PORT || '8181';
  
  if (!import.meta.env.VITE_ARCHIVEMIND_SERVER_PORT) {
    console.info('[Archivemind] Using default ARCHIVEMIND_SERVER_PORT: 8181');
  }
