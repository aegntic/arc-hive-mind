...
/**
 * ArchivemindLoadingSpinner - A loading animation component with neon trail effects
 *
 * This component displays the Archivemind logo with animated spinning circles
 ...
 */
export const ArchivemindLoadingSpinner: React.FC<{
  size?: 'sm' | 'md' | 'lg';
  logoSrc?: string;
  className?: string;
}> = ({
