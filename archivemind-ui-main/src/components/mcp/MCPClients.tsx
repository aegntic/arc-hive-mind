...
export const MCPClients = memo(() => {
  ...
  /**
   * Load all clients: Archivemind (hardcoded) + real database clients
   */
  const loadAllClients = async () => {
    try {
      ...
      // Load ALL clients from database (including Archivemind)
      ...
      // Set all clients (Archivemind will be included as a regular client)
