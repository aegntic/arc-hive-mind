...
import { ArchivemindChatPanel } from './ArchivemindChatPanel';
...
export const MainLayout: React.FC<MainLayoutProps> = ({
  ...
  return <div className="relative min-h-screen bg-white dark:bg-black overflow-hidden">
      ...
      {!isChatOpen && (
        <div className="fixed bottom-6 right-6 z-50 group">
          <button 
            ...
            <img src="/logo-neon.png" alt="Archivemind" className="w-7 h-7 grayscale opacity-50" />
          </button>
          {/* Tooltip */}
      ...
      transform: isChatOpen ? 'translateX(0)' : 'translateX(100%)'
        ...
        <ArchivemindChatPanel data-id="archivemind-chat" />
      </div>
    </div>;
};
