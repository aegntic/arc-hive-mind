...
import { ArchivemindLoadingSpinner, EdgeLitEffect } from '../animations/Animations';
import { agentChatService, ChatMessage } from '../../services/agentChatService';

/**
 * Props for the ArchivemindChatPanel component
 */
interface ArchivemindChatPanelProps {
  'data-id'?: string;
}
/**
 * ArchivemindChatPanel - A chat interface for the Archivemind AI assistant
 *
 ...
 */
export const ArchivemindChatPanel: React.FC<ArchivemindChatPanelProps> = props => {
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-zinc-800/80">
          <div className="flex flex-col gap-2">
            <div className="flex items-center">
              {/* Archivemind Logo - No animation in header */}
              <div className="relative w-8 h-8 mr-3 flex items-center justify-center">
                <img src="/logo-neon.png" alt="Archivemind" className="w-6 h-6 z-10 relative" />
              </div>
                ...
                <div className="flex items-center mb-1">
                  {message.sender === 'agent' ? (
                    <div className="w-4 h-4 mr-1 flex items-center justify-center">
                      <img src="/logo-neon.png" alt="Archivemind" className="w-full h-full" />
                    </div>
                  ) : (
          ...
          {(isTyping && !isStreaming) && (
            <div className="flex justify-start">
              <div className="max-w-[80%] mr-auto flex items-center justify-center py-4">
                <ArchivemindLoadingSpinner size="md" />
