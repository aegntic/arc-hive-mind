...
import { ArchivemindLoadingSpinner } from '../animations/Animations';
...
const ASSIGNEE_OPTIONS = ['User', 'Archivemind', 'AI IDE Agent'] as const;
            ...
            >
              {isSavingTask ? (
                <span className="flex items-center">
                  <ArchivemindLoadingSpinner size="sm" className="mr-2" />
