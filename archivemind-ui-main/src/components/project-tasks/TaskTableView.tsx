...
export interface Task {
  ...
  assignee: {
    name: 'User' | 'Archivemind' | 'AI IDE Agent';
    avatar: string;
  };
  feature: string;
  featureColor: string;
...
const getAssigneeGlassStyle = (assigneeName: 'User' | 'Archivemind' | 'AI IDE Agent') => {
  switch (assigneeName) {
    case 'User':
  ...
  const handleUpdateField = async (field: string, value: string) => {
    if (onTaskUpdate) {
      ...
      if (field === 'title') {
        ...
        updates.assignee = { name: value as 'User' | 'Archivemind' | 'AI IDE Agent', avatar: '' };
          ...
          {editingField === 'assignee' && (
            <div className="absolute z-50 mt-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg p-2">
              ...
              >
                ...
                <option value="Archivemind">Archivemind</option>
      ...
      <td className="p-3">
        <select
          ...
          onChange={(e) => setNewTask(prev => ({ 
            ...prev, 
            assignee: { name: e.target.value as 'User' | 'Archivemind' | 'AI IDE Agent', avatar: '' }
          }))}
          className="w-full bg-white/90 dark:bg-black/90 border border-cyan-300 dark:border-cyan-600 rounded px-2 py-1.5 text-sm focus:outline-none focus:border-cyan-500 focus:shadow-[0_0_5px_rgba(34,211,238,0.3)]"
        >
          <option value="AI IDE Agent">AI IDE Agent</option>
