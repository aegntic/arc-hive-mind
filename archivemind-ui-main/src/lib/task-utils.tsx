...
export const getAssigneeIcon = (assigneeName: 'User' | 'Archivemind' | 'AI IDE Agent') => {
  switch (assigneeName) {
    case 'User':
    ...
    case 'Archivemind':
      return <img src="/logo-neon.png" alt="Archivemind" className="w-4 h-4" />;
    default:
      return <User className="w-4 h-4 text-blue-400" />;
  }
};

export const getAssigneeGlow = (assigneeName: 'User' | 'Archivemind' | 'AI IDE Agent') => {
  switch (assigneeName) {
    case 'User':
