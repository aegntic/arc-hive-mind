...
// Based on database schema in migration/archivemind_tasks.sql
...
export type Assignee = 'User' | 'Archivemind' | 'AI IDE Agent';
...
export interface Project {
  ...
  created_at: string;
  updated_at: string;
  technical_sources?: string[]; // Array of source IDs from archivemind_project_sources table
  business_sources?: string[]; // Array of source IDs from archivemind_project_sources table
