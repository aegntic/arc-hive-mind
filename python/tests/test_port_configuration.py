...
class TestPortConfiguration:
    ...
    def test_service_discovery_requires_all_ports(self):
        ...
        for key in ["ARCHIVEMIND_SERVER_PORT", "ARCHIVEMIND_MCP_PORT", "ARCHIVEMIND_AGENTS_PORT"]:
            os.environ.pop(key, None)

        # Import should fail without environment variables
        with pytest.raises(ValueError, match="ARCHIVEMIND_SERVER_PORT environment variable is required"):
    ...
    def test_service_discovery_requires_mcp_port(self):
        ...
        os.environ.pop("ARCHIVEMIND_MCP_PORT", None)
        os.environ["ARCHIVEMIND_AGENTS_PORT"] = "8052"

        with pytest.raises(ValueError, match="ARCHIVEMIND_MCP_PORT environment variable is required"):
            from src.server.config.service_discovery import ServiceDiscovery
    ...
    def test_service_discovery_requires_agents_port(self):
        ...
        os.environ.pop("ARCHIVEMIND_AGENTS_PORT", None)

        with pytest.raises(ValueError, match="ARCHIVEMIND_AGENTS_PORT environment variable is required"):
            from src.server.config.service_discovery import ServiceDiscovery
    ...
    def test_service_discovery_with_all_ports(self):
        ...
        os.environ["ARCHIVEMIND_SERVER_PORT"] = "9191"
        os.environ["ARCHIVEMIND_MCP_PORT"] = "9051"
        os.environ["ARCHIVEMIND_AGENTS_PORT"] = "9052"
    ...
    def test_mcp_server_requires_port(self):
        """Test that MCP server requires ARCHIVEMIND_MCP_PORT."""
        os.environ.pop("ARCHIVEMIND_MCP_PORT", None)
    ...
    def test_main_server_requires_port(self):
        """Test that main server requires ARCHIVEMIND_SERVER_PORT when run directly."""
        os.environ.pop("ARCHIVEMIND_SERVER_PORT", None)
    ...
    def test_agents_server_requires_port(self):
        """Test that agents server requires ARCHIVEMIND_AGENTS_PORT."""
        os.environ.pop("ARCHIVEMIND_AGENTS_PORT", None)
    ...
    def test_agent_chat_api_requires_agents_port(self):
        """Test that agent_chat_api requires ARCHIVEMIND_AGENTS_PORT for service calls."""
        os.environ.pop("ARCHIVEMIND_AGENTS_PORT", None)
    ...
    def test_config_requires_port_or_archivemind_mcp_port(self):
        """Test that config.py requires PORT or ARCHIVEMIND_MCP_PORT."""
        ...
        with pytest.raises(
            ConfigurationError, match="PORT or ARCHIVEMIND_MCP_PORT environment variable is required"
        ):
    ...
    def test_custom_port_values(self):
        ...
        # Set custom ports
        os.environ["ARCHIVEMIND_SERVER_PORT"] = "9999"
        os.environ["ARCHIVEMIND_MCP_PORT"] = "8888"
        os.environ["ARCHIVEMIND_AGENTS_PORT"] = "7777"
...
class TestPortValidation:
    ...
    def test_invalid_port_values(self):
        ...
        os.environ["ARCHIVEMIND_SERVER_PORT"] = "not-a-number"
        os.environ["ARCHIVEMIND_MCP_PORT"] = "8051"
        os.environ["ARCHIVEMIND_AGENTS_PORT"] = "8052"
    ...
    def test_port_out_of_range(self):
        ...
        for port_value, should_succeed in test_cases:
            os.environ["ARCHIVEMIND_SERVER_PORT"] = port_value
            os.environ["ARCHIVEMIND_MCP_PORT"] = "8051"
            os.environ["ARCHIVEMIND_AGENTS_PORT"] = "8052"
