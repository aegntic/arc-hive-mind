...
class MCPErrorFormatter:
    ...
    def from_exception(exception: Exception, operation: str, context: dict[str, Any] | None = None) -> str:
        ...
        if isinstance(exception, httpx.ConnectTimeout):
            ...
            suggestion = "Check if the ArchiveMind server is running and accessible at the configured URL"
            ...
            suggestion = "Ensure the ArchiveMind server is running on the correct port"
