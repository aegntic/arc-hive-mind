...
class HybridSearchStrategy:
    ...
    async def keyword_search(
        ...
        Args:
            ...
            table_name: The table to search (documents, archivemind_crawled_pages, or archivemind_code_examples)
        ...
        try:
            ...
            for keyword in search_terms[:6]:  # Limit to avoid too many queries
                ...
                if table_name == "archivemind_code_examples":
    ...
    async def search_documents_hybrid(
        ...
        """
        Perform hybrid search on archivemind_crawled_pages table combining vector and keyword search.
        ...
        with safe_span("hybrid_search_documents") as span:
            try:
                ...
                vector_results = await self.base_strategy.vector_search(
                    ...
                    table_rpc="match_archivemind_crawled_pages",
                )
                ...
                keyword_results = await self.keyword_search(
                    ...
                    table_name="archivemind_crawled_pages",
                    filter_metadata=filter_metadata,
    ...
    async def search_code_examples_hybrid(
        ...
        """
        Perform hybrid search on archivemind_code_examples table combining vector and keyword search.
        ...
        with safe_span("hybrid_search_code_examples") as span:
            try:
                ...
                vector_results = await self.base_strategy.vector_search(
                    ...
                    table_rpc="match_archivemind_code_examples",
                )
                ...
                keyword_results = await self.keyword_search(
                    query=query,
                    match_count=match_count * 2,
                    table_name="archivemind_code_examples",
