...
**Archivemind's MCP implementation follows a clear separation of concerns:**
...
The Model Context Protocol (MCP) is an open standard that enables AI applications to securely access external data sources and tools. Archivemind implements both sides of MCP:
...
<div className="row">
  <div className="col col--6">
    <div className="card">
      ...
      <div className="card__body">
        <p>Archivemind as an MCP Server - Expose your knowledge base to AI clients</p>
        <ul>
  ...
  <div className="col col--6">
    <div className="card">
      ...
      <div className="card__body">
        <p>Universal MCP Client - Connect to any SSE-based MCP server from Archivemind's UI</p>
        <ul>
...
graph TB
    ...
    %% Archivemind's Client can also connect to its own server
...
<Tabs>
<TabItem value="server" label="Using Archivemind as MCP Server" default>

Connect your AI client to Archivemind's knowledge base:

1. Start Archivemind (Docker or local)
...
**For Claude Code:**
```bash
claude mcp add --transport sse Archivemind http://localhost:8051/sse
```
...
Connect to any MCP server from Archivemind's UI:

1. Open Archivemind UI → Navigate to MCP Client tab
...
- **Archivemind**: Your own knowledge base
...
**Archivemind provides 14 comprehensive MCP tools following modern patterns:**
...
## 🔥 Why Choose Archivemind's MCP Implementation?
...
**Archivemind's MCP implementation prioritizes developer experience with comprehensive tooling, detailed documentation, and real-time debugging capabilities.**
...
|----------|---------|----------|
| **[🛠️ MCP Server Guide](/mcp-server)** | Complete server setup, configuration, and troubleshooting | Developers using Archivemind as an MCP server |
...
Choose your path based on how you want to use Archivemind's MCP capabilities:

<Tabs>
<TabItem value="expose" label="🛠️ Expose Archivemind as MCP Server">

**You want to connect external AI clients (Cursor, Windsurf, etc.) to Archivemind's knowledge base**
...
**You want to use Archivemind's UI to connect to and test various MCP servers**
...
**You want to use Archivemind as both a server and client for maximum functionality**
...
<div className="text--center">
  ...
  <p>Join thousands of developers already using Archivemind's MCP tools to supercharge their AI workflows!</p>
</div> 