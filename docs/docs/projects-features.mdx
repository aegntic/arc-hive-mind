---
title: Archivemind Projects Features
sidebar_position: 2
---
...
# 📊 Archivemind Projects: Complete Feature Reference

<div className="hero hero--secondary">
  <div className="container">
    <h2 className="hero__subtitle">
      Everything you can do with Archivemind Projects - from simple task tracking to complex project orchestration with AI assistance.
    </h2>
  </div>
</div>
...
- **Task Assignment**: Assign to User, Archivemind, or AI IDE Agent
