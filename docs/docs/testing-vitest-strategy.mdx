...
This document outlines Archivemind's comprehensive frontend testing strategy using Vitest with React and TypeScript, incorporating the latest best practices and our current implementation.
...
Archivemind includes a sophisticated UI test runner accessible from the Settings page:
  ...
  test:
    ...
    - name: Setup Node.js
      ...
      with:
        node-version: '20'
        cache: 'npm'
        cache-dependency-path: Archivemind-ui-main/package-lock.json
    
    - name: Install dependencies
      working-directory: ./Archivemind-ui-main
      run: npm ci
    ...
    - name: Upload coverage reports
      ...
      with:
        file: ./Archivemind-ui-main/coverage/coverage-final.json
        flags: frontend
