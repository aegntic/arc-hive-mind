...
This document outlines Archivemind's Python testing strategy for our multi-container architecture, emphasizing simplicity and effectiveness.
...
async def mcp_server():
    ...
    from src.mcp.mcp_server import ArchivemindMCPServer
    server = ArchivemindMCPServer()
    # Mock dependencies
