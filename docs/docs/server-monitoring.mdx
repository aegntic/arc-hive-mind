...
<div className="hero hero--primary">
  <div className="container">
    <h2 className="hero__subtitle">
      **Monitor your Archivemind services**: Health checks, performance metrics, and troubleshooting tools
    </h2>
  </div>
</div>

Archivemind provides built-in monitoring and health checking across all services to help you maintain optimal performance and quickly troubleshoot issues.
...
Monitor the status of all Archivemind services:
...
Archivemind tracks important performance metrics:
...
Use the health endpoints and browser developer tools to quickly diagnose issues with your Archivemind installation.
</Admonition>
...
docker-compose logs -f Archivemind-mcp
```
...
API_BASE_URL=http://Archivemind-server:8080
```

### Unified Logging System

Archivemind includes a unified logging system with optional [Logfire](https://logfire.pydantic.dev/) integration:
...
Archivemind automatically manages resources:
