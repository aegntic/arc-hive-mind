...
The Agents Service (`Archivemind-agents`) runs on port 8052 and contains three specialized PydanticAI agents:
...
ENV MCP_SERVER_URL=http://Archivemind-mcp:8051
