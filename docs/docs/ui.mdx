...
- **RAG Settings**:
  ...
  - Reranking toggle
  - Model selection
- **Archivemind Unit Tests** (Collapsible):
...
6. **ArchivemindChatPanel** - Consider virtualization for long chat histories
