...
# 🚀 Getting Started with Archivemind
...
By the end of this guide, you'll have a **fully operational Archivemind system** with:
- ✅ **14 MCP tools** enabled and working
- 🧠 **RAG system** for intelligent knowledge retrieval
- 🌐 **Archivemind UI** Command Center for knowledge, projects, and tasks
...
Archivemind is a **Model Context Protocol (MCP) server** that creates a centralized knowledge base for your AI coding assistants. Connect Cursor, Windsurf, or Claude Desktop to give your AI agents access to:
...
**Run `migration/2_archivemind_projects.sql`** - Creates project and task management tables
...
Archivemind includes Hot Module Reload (HMR) for both Python and React code. Changes to source files automatically reload without container rebuilds.
...
Your Archivemind system is now running with **14 MCP tools** available. Your AI agents can now access your knowledge base!
</Admonition>
...
graph TB
    subgraph "🚀 Docker Microservices Stack"
        Frontend["🌐 Frontend Container<br/>React + Vite<br/>archivemind-frontend<br/>Port 3737"]
        API["⚡ Server Container<br/>FastAPI + Socket.IO<br/>Archivemind-Server<br/>Port 8080"]
        MCP["🔧 MCP Server<br/>14 MCP Tools<br/>archivemind-mcp<br/>Port 8051"]
        Agents["🤖 Agents Service<br/>AI Processing<br/>archivemind-agents<br/>Port 8052"]
        Docs["📚 Documentation<br/>Docusaurus<br/>archivemind-docs<br/>Port 3838"]
    end
...
To connect Cursor to your Archivemind MCP server, add this configuration:
...
**QuickStart guide** to get Archivemind running in minutes
...
**[Deployment Guide](./deployment.mdx)** - Scale Archivemind for team and production use
...
docker compose logs archivemind-server
docker compose logs archivemind-mcp
docker compose logs archivemind-agents
```
...
docker compose exec archivemind-server env | grep -E "(SUPABASE|OPENAI)"
...
- **🐛 [GitHub Issues](https://github.com/coleam00/archivemind/issues)** - Bug reports and feature requests
...
<p align="center">
  ...
  <em>Transform your AI coding experience with Archivemind</em>
</p> 