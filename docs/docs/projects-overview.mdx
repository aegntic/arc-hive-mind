---
title: Archivemind Projects Overview
sidebar_position: 1
---
...
# 📊 Archivemind Projects: AI-Powered Project Management
...
Archivemind Projects brings intelligent project management to your AI development workflow. Your AI assistants can understand project context, create and update tasks, manage documentation, and help you stay organized while you code.

## 🎯 Overview

The Archivemind task management system provides:
...
Archivemind uses a simple but flexible data structure:
...
1. **Open Archivemind**: Navigate to http://localhost:3737
...
3. **Fill Details**:
   ...
   - **Assignee**: Choose from User, Archivemind, or AI IDE Agent
...
When creating projects, Archivemind automatically generates a structured PRD:
...
Archivemind provides built-in progress tracking:
